...
You have two options - you can use the `history` function and get a previous day’s data OR you can attempt to collect this data “in real time” (of course this would require usage of the Cloudwatch Events trigger on Lambda). Using the `history` function is definitely the easier approach and I would recommend starting there.
...
![cluster](/assets/ Kinesis_configuration.png)
